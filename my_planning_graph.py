...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        pos_a1 = set(node_a1.action.effect_add).isdisjoint(set(node_a2.action.effect_rem))
        pos_a2 = set(node_a2.action.effect_add).isdisjoint(set(node_a1.action.effect_rem))

        return not pos_a1 and pos_a2
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        precond_pos_a1 = set(node_a1.action.effect_add).isdisjoint(node_a2.action.precond_neg)
        precond_neg_a1 = set(node_a1.action.effect_rem).isdisjoint(node_a2.action.precond_pos)
        precond_pos_a2 = set(node_a2.action.effect_add).isdisjoint(node_a1.action.precond_neg)
        precond_neg_a2 = set(node_a2.action.effect_rem).isdisjoint(node_a1.action.precond_pos)

        return not (precond_pos_a1 and precond_neg_a1 and precond_pos_a2 and precond_neg_a2)
